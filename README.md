[![Build Status](https://travis-ci.org/anaporia/js-training.svg?branch=master)](https://travis-ci.org/anaporia/js-training)
## Setup
First, [**fork**](https://github.com/anaporia/js-training/fork?fragment=1) this repository.
